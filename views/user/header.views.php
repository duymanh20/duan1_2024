      ...
      <div class="collapse navbar-collapse" id="navbarExample01">
        ...
        <?php
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="index.php?type=contact">Đơn hàng của bạn</a></li>
          </ul>
        </li>
            <li class="nav-item" >
...
?>
        ...
        <form class="d-flex" action="index.php?type=cate" method="post" role="search">
  ...
  <?php
  if(isset($_GET['type'])){
    if($_GET['type']!=='login' && $_GET['type']!=='donedeal' && $_GET['type']!=='regis' && $_GET['type']!=='cart' && $_GET['type']!=='updateinfor' && $_GET['type']!=='changepass' && $_GET['type']!=='contact' && $_GET['type']!=='detail'  && $_GET['type']!=='wishlist'){
      echo'
      <div
